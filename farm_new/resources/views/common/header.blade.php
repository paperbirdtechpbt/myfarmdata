...
{{--                <option value="2" >Sabari(Gujarati Medium)</option>--}}
{{--                <option value="3" >Markaz (English Medium)</option>--}}
            </select> -->
        </form>
    </li>
    <!-- END SEARCH -->
    ...
    <li class="xn-icon-button pull-right">
        ...
        <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
            <div class="panel-heading">
                <h3 class="panel-title"><span class="fa fa-user"></span> {{Auth::user()->name}}</h3>
            </div>
            <div class="panel-body list-group list-group-contacts scroll" style="height: 80px;">

                <a href="{{ url('/resetpassword') }}" class="list-group-item">
                    <span class="fa fa-list"> Change Password</span>
                </a>
                <a class="mb-control list-group-item" data-box="#mb-signout" style="cursor:pointer;">
