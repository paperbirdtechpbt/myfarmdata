                                    ...
                                    htmlData += '<div class="col-md-4">';
                                        htmlData += '<div class="panel panel-default" >';
                                            ...
                                            htmlData += '<div class="panel-body">';
                                                ...
                                                htmlData += '<div id="legend_'+dashboard_setting+'_'+v.id+'_'+v1.id+'" class="bars-legend"></div>';
                                            htmlData += '</div>';
                                        htmlData += '</div>';
                                    htmlData += '</div>';
...
console.log(new_arr);
                                ...
                                if(point_count == true){
                                    ...
                                    if(v.graph_type == 'Line chart'){
                                        config.element = 'line_'+dashboard_setting+'_'+v.id+'_'+v1.id;
                                        ...
                                        browsersChart.options.labels.forEach(function(label, i) {
                                            var legendItem = $('<span></span>').text( label).prepend('<br><span>&nbsp;</span>');
                                                legendItem.find('span')
                                                  ...
                                                  .css('margin', '3px');
                                            $('#legend_'+dashboard_setting+'_'+v.id+'_'+v1.id).append(legendItem);
                                        });
