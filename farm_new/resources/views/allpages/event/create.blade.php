...
@endphp
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" id="add_form" method="post" action="/event">
                {{csrf_field()}}
                        ...
                        <div class="row col-md-12" >
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="date" class="form-control" name="exp_start_date" id="exp_start_date">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Start Date <span class="mandatory">*</span></label>
                                    <div class="col-md-9">
                                        <input type="date" class="form-control" name="actual_start_date" id="actual_start_date" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row col-md-12" >
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="date" class="form-control" name="actual_end_date" id="actual_end_date" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row col-md-12" >
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="exp_duration" id="exp_duration">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="actual_duration" id="actual_duration" >
                                    </div>
                                </div>
                            </div>
                        </div>
