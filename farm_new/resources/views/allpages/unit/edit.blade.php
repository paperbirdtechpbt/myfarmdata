...
@section('maincontent')
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" id="add_form" method="post" action="/unit/{{$unit->id}}">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Edit</strong> Units</h3>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="description" id="description" value="{{$unit->description}}">
                                    <span class="help-block">This field is required</span>
                                </div>
                            </div> 
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="communitygroup" id="communitygroup">
                                        ...
                                        @foreach($communitygrp as $value)<option value="{{$value->id}}" @if($unit->communitygroup  == $value->id) selected @endif>{{$value->name}}</option>@endforeach
                                    </select>
                                </div>
                            </div>
                        </div>
