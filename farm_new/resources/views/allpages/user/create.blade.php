                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="family_name" id="family_name" value="{{old('name')}}">
                                            <span class="help-block">This field is required</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="password" class="form-control" name="password" id="password" maxlength="8" value="">
                                            <span class="help-block">This field is required</span>
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <select multiple class="form-control select" name="collectactivityid" id="collectactivityid" value="{{old('name')}}">
                                                <!--<option value="">select</option>-->
                                                @foreach($collectactivity as $collect_activity)
                                                <option value="{{$collect_activity->id}}">{{$collect_activity->name}}</option>
                                                @endforeach
                                            </select>
                                            <span class="help-block">This field is required</span>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <select multiple class="form-control select" name="roleid" id="roleid" value="{{old('name')}}">
                                                <!--<option value="">select</option>-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="external_id" id="external_id" value="{{old('name')}}">
                                            <span class="help-block">This field is required</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <!-- <input type="text" class="form-control" name="address" id="address" value=""> -->
                                            <select class="form-control select" name="is_active" id="is_active" value="{{old('name')}}">
                                                <option value="">select</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <select multiple class="form-control select" name="communitygroupid" id="communitygroupid" value="{{old('name')}}">
                                                <!--<option value="">select</option>-->
