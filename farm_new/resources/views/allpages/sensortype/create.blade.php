...
@section('breadcrumb')
    <li><a href="#">Home</a></li>
    <li class="active">Create Sensor Type</li>
@endsection
...
@section('maincontent')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" id="add_form" method="post" action="/sensortype">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Create</strong> Sensor Type</h3>
